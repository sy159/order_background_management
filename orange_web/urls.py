...
urlpatterns = [
    ...
    path('admin/add_originalform/', cache_page(60 * 60 * 24 * 10)(merchants.add_originalform)),  # 添加商户分类
    ...
    path('admin/add_childform/', cache_page(60 * 60 * 24 * 10)(merchants.add_childform)),  # 添加子分类
    ...
    path('admin/store_add/', cache_page(60 * 60 * 24 * 10)(promotion_market.store_add)),  # 添加推荐店铺弹窗
    path('admin/store_edit/', promotion_market.store_edit),  # 编辑店铺弹窗

    # 配送管理
    path('admin/marki_manage/', deliver.marki_manage),  # 配送管理
    path('admin/user_add/', cache_page(60 * 60 * 24 * 10)(deliver.user_add)),  # 添加管理员
